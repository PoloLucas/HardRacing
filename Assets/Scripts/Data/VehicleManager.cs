...
public class VehicleManager : ScriptableObject{
    ...
    [SerializeField]private float baseBrakingForce;
    ...
    [SerializeField]private float basePlayerBrakingForce;
    ...
    public void ResetValues(VehicleData vehicle){
        ...
        vehicle.BrakingForce = baseBrakingForce;
    ...
    public void SetPlayerValues(VehicleData vehicle){
        ...
        vehicle.BrakingForce = basePlayerBrakingForce;
